import { Button, Container, FormControl, FormControlLabel, FormLabel, Grid, Paper, Radio, RadioGroup, TextField } from '@mui/material'
        ...
        registerNewUser(currentUser)
            .then(res => {
                if (res[0]) {
                    ...
                    setOpen({ show: true, type: "success", message: "Registered Successfull" });
